...
for i in range(30):
    for dataset in ["synthetic_dataset"]:
        ...
        for exp in [
            ...
            gpgomea_experiment({"csv_name":"tree_42", "depth": 4, "dir": directory, "batch_size": 256, "ff": "mse", "seed": i, "coeff_p": 0., "MO_mode": True, "popsize":popsize, "n_clusters": 7, "max_coeffs": 0, "nr_multi_trees": 2,  "t": 600, "g":-1, "use_adf":True, "use_aro": False, "dataset": dataset, "fset": sin_fset, "log": True, "verbose": verbose, "contains_train": contains_train, "use_mse_opt": False, "ss": False, "use_ftol": False, "optimize": True, "discount_size":True}),
            gpgomea_experiment({"csv_name":"tree_7", "depth": 7, "dir": directory, "batch_size": 256, "ff": "mse", "seed": i, "coeff_p": 0., "MO_mode": True, "popsize":popsize, "n_clusters": 7, "max_coeffs": 0, "nr_multi_trees": 1,  "t": 600, "g":-1, "use_adf":True, "use_aro":False , "dataset": dataset, "fset": sin_fset, "log": True, "verbose": verbose, "contains_train": contains_train, "use_mse_opt": False, "ss": False, "use_ftol": False, "optimize": True, "discount_size":True})
