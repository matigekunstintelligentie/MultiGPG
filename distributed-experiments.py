...
for i in range(10):
    for dataset in datasets:
        ...
        for exp in [
            ...
            #gpgomea_experiment({"csv_name":"MO_equalclustersize_balanced_frac1_noadf", "depth":  4, "dir": directory, "batch_size": 256, "ff": "lsmse", "seed": i, "coeff_p": 1., "MO_mode": True, "popsize":popsize*5, "n_clusters": 5, "max_coeffs": -1, "nr_multi_trees": 4,  "t": duration, "g":generations, "use_adf":False, "use_aro": True, "dataset": dataset, "fset": fset, "log": True, "verbose": verbose, "contains_train": contains_train, "use_mse_opt": False, "ss": False, "use_ftol": False, "optimize": True, "discount_size":False,"balanced":True,"k2":False,"log_pop":False,"donor_fraction":1.}),
            #gpgomea_experiment({"csv_name":"MO_equalclustersize_balanced_frac1_discount", "depth":  4, "dir": directory, "batch_size": 256, "ff": "lsmse", "seed": i, "coeff_p": 1., "MO_mode": True, "popsize":popsize*5, "n_clusters": 5, "max_coeffs": -1, "nr_multi_trees": 4,  "t": duration, "g":generations, "use_adf":True, "use_aro": False, "dataset": dataset, "fset": fset, "log": True, "verbose": verbose, "contains_train": contains_train, "use_mse_opt": False, "ss": False, "use_ftol": False, "optimize": True, "discount_size":True,"balanced"True,"k2":False,"log_pop":False,"donor_fraction":1.}),
