...
namespace g {
  ...
  void read_options(int argc, char** argv) {
    ...
    parser.set_optional<bool>("log_pop", "log_pop", false, "Whether to log the population clusters");
    parser.set_optional<string>("csv_file", "csv_file", "required.csv", "CSV file that is written to.");
    parser.set_optional<string>("csv_file_pop", "csv_file_pop", "required_pop.csv", "CSV pop file that is written to.");
    // coefficients and range
