...
g = GPGRegressor(t=args.t, g=args.g, tour=args.tour, d=args.depth,  use_optim=args.optimize,
        ...
        bs=2048,
        verbose=args.verbose, csv_file="{}/{}_{}_{}.csv".format(args.dir, args.seed, args.csv_name, args.dataset), csv_file_pop="{}/pop/{}_{}_{}.csv".format(args.dir, args.seed, args.csv_name, args.dataset), opt_per_gen=args.every_n_steps, use_clip=args.clip,
        fset=args.fset, cmp=args.coeff_p, use_ftol=args.use_ftol, tol=1e-9, use_mse_opt=args.use_mse_opt, log=args.log, log_pop=args.log_pop, ff=args.ff,
